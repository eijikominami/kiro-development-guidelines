...
#### 2. 設定ファイルの作成（.pre-commit-config.yaml）
...
## 2. Pre-commit と CI/CD の連携

### 重要原則
CI/CD で実行される品質チェックは、可能な限り pre-commit でもローカル実行できるようにする

### CI/CD チェック項目の Pre-commit 対応
